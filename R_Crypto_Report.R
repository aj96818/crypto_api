# Windows batch file contents:

# @echo on
# "C:\Program Files\R\R-4.0.2\bin\x64\R.exe" CMD BATCH C:\Users\aljackson\Documents\My_R_Scripts\crypto_report.R
...
coin_api <- coin_api[!coin_api$name %in% c('golden-ratio-token', 'unicorn-token', 'universe', 'stox', 'luna-coin', 'thorchain-erc20'),]
